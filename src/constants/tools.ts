...
export const TOOLS: Tool[] = [
  ...
  { name: 'Image Compressor', description: 'Compress multiple JPG images.', path: '/image-compressor', Icon: FileArchiveIcon, Page: ImageCompressorPage, category: 'Image Tools', borderColor: 'border-purple-400' },
  ...
  { name: 'Image Download Button Generator', description: 'Create an HTML download button for an image.', path: '/image-download-button-generator', Icon: FileDownIcon, Page: ImageDownloadButtonGeneratorPage, category: 'Image Tools', borderColor: 'border-green-600' },
  ...
  { name: 'List Shuffler', description: 'Randomize the order of lines in a list.', path: '/list-shuffler', Icon: ShuffleIcon, Page: ListShufflerPage, category: 'Text & List Tools', borderColor: 'border-purple-400' },
  ...
  { name: 'Text Scrambler', description: 'Scramble the middle letters of words.', path: '/text-scrambler', Icon: ShuffleIcon, Page: TextScramblerPage, category: 'Text & List Tools', borderColor: 'border-amber-500' },
  ...
  { name: 'Scientific Calculator', description: 'Advanced calculator for scientific functions.', path: '/scientific-calculator', Icon: CalculatorIcon, Page: ScientificCalculatorPage, category: 'Calculators & Time Tools', borderColor: 'border-teal-500' },
  { name: 'Compound Interest Calculator', description: 'Calculate compound interest over time.', path: '/compound-interest-calculator', Icon: CalculatorIcon, Page: CompoundInterestCalculatorPage, category: 'Calculators & Time Tools', borderColor: 'border-teal-500' },
  ...
  { name: 'List Randomizer', description: 'Pick a random item from a list.', path: '/list-randomizer', Icon: ShuffleIcon, Page: ListRandomizerPage, category: 'Calculators & Time Tools', borderColor: 'border-fuchsia-500' },
  ...
  { name: 'Base64 Image Size Calculator', description: 'Calculate the size of a Base64 encoded image.', path: '/base64-image-size-calculator', Icon: FileArchiveIcon, Page: Base64ImageSizeCalculatorPage, category: 'Web & Developer Tools', borderColor: 'border-yellow-500' },
  ...
  { name: 'JSON Array Shuffler', description: 'Randomize the order of items in a JSON array.', path: '/json-array-shuffler', Icon: ShuffleIcon, Page: JsonArrayShufflerPage, category: 'Web & Developer Tools', borderColor: 'border-indigo-500' },
  ...
  { name: 'PDF File Size Checker', description: 'Check the file size of a PDF.', path: '/pdf-file-size-checker', Icon: FileArchiveIcon, Page: PdfFileSizeCheckerPage, category: 'PDF & Document Tools', borderColor: 'border-green-500' },
  { name: 'PDF Compression Ratio Checker', description: 'Check the compression ratio of a PDF.', path: '/pdf-compression-ratio-checker', Icon: FileArchiveIcon, Page: PdfCompressionRatioCheckerPage, category: 'PDF & Document Tools', borderColor: 'border-green-500' },
  ...
  { name: 'PDF File Optimizer', description: 'Optimize a PDF to reduce its file size.', path: '/pdf-file-optimizer', Icon: FileArchiveIcon, Page: PdfFileOptimizerPage, category: 'PDF & Document Tools', borderColor: 'border-green-500' },
  ...
  { name: 'File Size Converter', description: 'Convert between different file size units.', path: '/file-size-converter', Icon: FileArchiveIcon, Page: FileSizeConverterPage, category: 'File Converters & Utilities', borderColor: 'border-purple-500' },
