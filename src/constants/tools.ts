...
import {
  ...
  FileEdit,
  // FIX: Added FileInput to the import list.
  FileInput,
  FileImage,
  FileLock,
  FileMinus,
  ...
  FileText,
  FileUp,
  // FIX: Added Fingerprint to the import list.
  Fingerprint,
  FlipHorizontal,
  FlipVertical,
  GanttChart,
  Globe,
  // FIX: Added Grid to the import list.
  Grid,
  HandCoins,
  Hash,
  ImageOff,
  // FIX: Added Info to the import list.
  Info,
  Key,
  Languages,
  // FIX: Added Layout to the import list.
  Layout,
  Link,
  List,
  ListChecks,
  ...
  Scissors,
  Search,
  // FIX: Added Server to the import list.
  Server,
  ...
  Sparkles,
  Split,
  // FIX: Added Square to the import list.
  Square,
  Superscript,
  Timer,
  Type,
