...
// FIX: Add missing import for Base64ImageSizeCalculatorIcon
import { Base64ImageSizeCalculatorIcon } from '../components/icons/Base64ImageSizeCalculatorIcon';
// FIX: Add missing import for Base64ImageSizeCalculatorPage
...
// FIX: Add missing import for ColorPaletteGeneratorIcon
import { ColorPaletteGeneratorIcon } from '../components/icons/ColorPaletteGeneratorIcon';
// FIX: Add missing import for ColorPaletteGeneratorPage
...
export const TOOLS: Tool[] = [
  ...
  { name: 'Image Watermark Positioner', description: 'Add and position a watermark on an image.', path: '/image-watermark-positioner', Icon: ImageWatermarkPositionerIcon, Page: ImageWatermarkPositionerPage, category: 'Image Tools', borderColor: 'border-rose-600', isPremium: true },
  { name: 'Image Canvas Resizer', description: 'Resize the canvas without scaling the image.', path: '/image-canvas-resizer', Icon: ImageCanvasResizerIcon, Page: ImageCanvasResizerPage, category: 'Image Tools', borderColor: 'border-purple-300', isPremium: true },
  { name: 'Image Hue Shifter', description: 'Shift the hue of an entire image.', path: '/image-hue-shifter', Icon: ImageHueShifterIcon, Page: ImageHueShifterPage, category: 'Image Tools', borderColor: 'border-pink-500', isPremium: true },
  { name: 'Image Noise Generator', description: 'Add noise or grain to an image.', path: '/image-noise-generator', Icon: ImageNoiseGeneratorIcon, Page: ImageNoiseGeneratorPage, category: 'Image Tools', borderColor: 'border-gray-400', isPremium: true },
  { name: 'Base64 to Image Decoder', description: 'Decode a Base64 string back into an image.', path: '/image-to-base64-decoder', Icon: ImageToBase64DecoderIcon, Page: ImageToBase64DecoderPage, category: 'Image Tools', borderColor: 'border-blue-200', isPremium: true },
  ...
  { name: 'Image Shadow Generator', description: 'Add a drop shadow effect to an image.', path: '/image-shadow-generator', Icon: ImageShadowGeneratorIcon, Page: ImageShadowGeneratorPage, category: 'Image Tools', borderColor: 'border-gray-300', isPremium: true },
  { name: 'Image to Black & White', description: 'Convert an image to black and white.', path: '/image-to-black-and-white', Icon: ImageToBlackAndWhiteIcon, Page: ImageToBlackAndWhitePage, category: 'Image Tools', borderColor: 'border-gray-500', isPremium: true },
  { name: 'Image Tiling Previewer', description: 'See how an image tiles as a background.', path: '/image-tiling-previewer', Icon: ImageTilingPreviewerIcon, Page: ImageTilingPreviewerPage, category: 'Image Tools', borderColor: 'border-gray-500', isPremium: true },
  { name: 'Image Color Replacer', description: 'Replace one color with another in an image.', path: '/image-color-replacer', Icon: ImageColorReplacerIcon, Page: ImageColorReplacerPage, category: 'Image Tools', borderColor: 'border-red-300', isPremium: true },
  ...
  { name: 'Image Layer Merger', description: 'Merge two images with various blend modes.', path: '/image-layer-merger', Icon: ImageLayerMergerIcon, Page: ImageLayerMergerPage, category: 'Image Tools', borderColor: 'border-purple-400', isPremium: true },
  { name: 'Image Opacity Slider', description: 'Adjust image opacity with a slider.', path: '/image-opacity-slider', Icon: ImageOpacitySliderIcon, Page: ImageOpacitySliderPage, category: 'Image Tools', borderColor: 'border-gray-500', isPremium: true },
  { name: 'Image Crop Preset', description: 'Crop images to preset social media sizes.', path: '/image-crop-preset', Icon: ImageCropPresetIcon, Page: ImageCropPresetPage, category: 'Image Tools', borderColor: 'border-rose-500', isPremium: true },
  { name: 'Image Metadata Editor', description: 'Edit EXIF and other metadata in images.', path: '/image-metadata-editor', Icon: ImageMetadataEditorIcon, Page: ImageMetadataEditorPage, category: 'Image Tools', borderColor: 'border-slate-600', isPremium: true },
  { name: 'Image Download Button Generator', description: 'Create an HTML download button for an image.', path: '/image-download-button-generator', Icon: ImageDownloadButtonGeneratorIcon, Page: ImageDownloadButtonGeneratorPage, category: 'Image Tools', borderColor: 'border-green-600', isPremium: true },
  { name: 'Image Zoom Previewer', description: 'Zoom in and out of an image.', path: '/image-zoom-previewer', Icon: ImageZoomPreviewerIcon, Page: ImageZoomPreviewerPage, category: 'Image Tools', borderColor: 'border-blue-700', isPremium: true },
  { name: 'Image Header Info Viewer', description: 'View the binary header of an image file.', path: '/image-header-info-viewer', Icon: ImageHeaderInfoViewerIcon, Page: ImageHeaderInfoViewerPage, category: 'Image Tools', borderColor: 'border-gray-700', isPremium: true },
  ...
  { name: 'Image Color Palette Saver', description: 'Extract and save a color palette from an image.', path: '/image-color-palette-saver', Icon: ImageColorPaletteSaverIcon, Page: ImageColorPaletteSaverPage, category: 'Image Tools', borderColor: 'border-emerald-500', isPremium: true },
  ...
  { name: 'Scientific Calculator', description: 'Advanced calculator for scientific functions.', path: '/scientific-calculator', Icon: ScientificCalculatorIcon, Page: ScientificCalculatorPage, category: 'Calculators & Time Tools', borderColor: 'border-teal-500', isPremium: true },
  ...
  { name: 'List Randomizer', description: 'Pick a random item from a list.', path: '/list-randomizer', Icon: ListRandomizerIcon, Page: ListRandomizerPage, category: 'Calculators & Time Tools', borderColor: 'border-fuchsia-500', isPremium: true },
  { name: 'Number Pad Generator', description: 'Generate a list of zero-padded numbers.', path: '/number-pad-generator', Icon: NumberPadGeneratorIcon, Page: NumberPadGeneratorPage, category: 'Calculators & Time Tools', borderColor: 'border-gray-500', isPremium: true },
  ...
  { name: 'Odd/Even Number Filter', description: 'Filter a list to keep only odd or even numbers.', path: '/odd-even-number-filter', Icon: OddEvenNumberFilterIcon, Page: OddEvenNumberFilterPage, category: 'Calculators & Time Tools', borderColor: 'border-lime-500', isPremium: true },
  ...
  { name: 'Scientific Notation Converter', description: 'Convert numbers to and from scientific notation.', path: '/scientific-notation-converter', Icon: ScientificNotationIcon, Page: ScientificNotationPage, category: 'Web & Developer Tools', borderColor: 'border-indigo-500', isPremium: true },
  ...
  { name: 'Base64 Image Size Calculator', description: 'Calculate the size of a Base64 encoded image.', path: '/base64-image-size-calculator', Icon: Base64ImageSizeCalculatorIcon, Page: Base64ImageSizeCalculatorPage, category: 'Web & Developer Tools', borderColor: 'border-yellow-500' },
  ...
  { name: 'Add Text Watermark to PDF', description: 'Add a text watermark to every page of a PDF.', path: '/pdf-watermark-adder-text', Icon: PdfWatermarkAdderTextIcon, Page: PdfWatermarkAdderTextPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'Add Image Watermark to PDF', description: 'Add an image watermark to every page of a PDF.', path: '/pdf-watermark-adder-image', Icon: PdfWatermarkAdderImageIcon, Page: PdfWatermarkAdderImagePage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'Encrypt PDF', description: 'Add a password to protect a PDF file.', path: '/pdf-encryptor', Icon: PdfEncryptorIcon, Page: PdfEncryptorPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'Reorder PDF Pages', description: 'Change the order of pages in a PDF.', path: '/reorder-pdf-pages', Icon: ReorderPdfPagesIcon, Page: ReorderPdfPagesPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'Rotate All PDF Pages', description: 'Rotate all pages in a PDF document.', path: '/rotate-all-pdf-pages', Icon: RotateAllPdfPagesIcon, Page: RotateAllPdfPagesPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'Delete PDF Pages', description: 'Remove specific pages from a PDF.', path: '/pdf-page-deleter', Icon: PdfPageDeleterIcon, Page: PdfPageDeleterPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'Crop PDF Pages', description: 'Crop the pages of a PDF document.', path: '/pdf-page-cropper', Icon: PdfPageCropperIcon, Page: PdfPageCropperPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  ...
  { name: 'Remove PDF Page Numbers', description: 'Remove page numbers from a PDF.', path: '/pdf-page-number-remover', Icon: PdfPageNumberRemoverIcon, Page: PdfPageNumberRemoverPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'Crop PDF Document', description: 'Crop all pages of a PDF at once.', path: '/pdf-document-cropper', Icon: PdfDocumentCropperIcon, Page: PdfDocumentCropperPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  ...
  { name: 'PDF Annotation Viewer', description: 'View all annotations in a PDF.', path: '/pdf-annotation-viewer', Icon: PdfAnnotationViewerIcon, Page: PdfAnnotationViewerPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'PDF Page Size Checker', description: 'Check the size of each page in a PDF.', path: '/pdf-page-size-checker', Icon: PdfPageSizeCheckerIcon, Page: PdfPageSizeCheckerPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  ...
  { name: 'PDF to HTML Converter', description: 'Convert a PDF to an HTML file.', path: '/pdf-to-html-converter', Icon: PdfToHtmlConverterIcon, Page: PdfToHtmlConverterPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'PDF Security Level Checker', description: 'Check the encryption level of a PDF.', path: '/pdf-security-level-checker', Icon: PdfSecurityLevelCheckerIcon, Page: PdfSecurityLevelCheckerPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'PDF File Optimizer', description: 'Optimize a PDF to reduce its file size.', path: '/pdf-file-optimizer', Icon: PdfFileOptimizerIcon, Page: PdfFileOptimizerPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  ...
  { name: 'Rotate Individual PDF Pages', description: 'Rotate specific pages in a PDF.', path: '/pdf-page-rotator-individual', Icon: PdfPageRotatorIndividualIcon, Page: PdfPageRotatorIndividualPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'Extract Pages from PDF', description: 'Extract a range of pages into a new PDF.', path: '/pdf-page-extractor', Icon: PdfPageExtractorIcon, Page: PdfPageExtractorPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'Insert Pages into PDF', description: 'Insert pages from one PDF into another.', path: '/pdf-page-inserter', Icon: PdfPageInserterIcon, Page: PdfPageInserterPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'Duplicate PDF Pages', description: 'Duplicate pages within a PDF.', path: '/pdf-page-duplicator', Icon: PdfPageDuplicatorIcon, Page: PdfPageDuplicatorPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'PDF Content Cleaner', description: 'Remove certain elements like images or text.', path: '/pdf-content-cleaner', Icon: PdfContentCleanerIcon, Page: PdfContentCleanerPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'PDF Form Field Viewer', description: 'View all form fields in a PDF.', path: '/pdf-form-field-viewer', Icon: PdfFormFieldViewerIcon, Page: PdfFormFieldViewerPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  ...
  { name: 'PDF Watermark Position Editor', description: 'Precisely position a watermark on a PDF.', path: '/pdf-watermark-position-editor', Icon: PdfWatermarkPositionEditorIcon, Page: PdfWatermarkPositionEditorPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'PDF Page Counter (Range)', description: 'Count pages in a specific range.', path: '/pdf-page-counter-range', Icon: PdfPageCounterRangeIcon, Page: PdfPageCounterRangePage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'PDF Page Number Format Changer', description: 'Change the format of page numbers.', path: '/pdf-page-number-format-changer', Icon: PdfPageNumberFormatChangerIcon, Page: PdfPageNumberFormatChangerPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  { name: 'PDF Text Replacer', description: 'Find and replace text within a PDF.', path: '/pdf-text-replacer', Icon: PdfTextReplacerIcon, Page: PdfTextReplacerPage, category: 'PDF & Document Tools', borderColor: 'border-green-500', isPremium: true },
  ...
  { name: 'File Merger', description: 'Merge multiple text-based files into one.', path: '/file-merger', Icon: FileMergerIcon, Page: FileMergerPage, category: 'File Converters & Utilities', borderColor: 'border-purple-500', isPremium: true },
  ...
  { name: 'PPTX to Text Extractor', description: 'Extract text from a PPTX file.', path: '/pptx-to-text-extractor', Icon: PptxToTextExtractorIcon, Page: PptxToTextExtractorPage, category: 'File Converters & Utilities', borderColor: 'border-purple-500', isPremium: true },
  ...
  { name: 'CSV Column Selector', description: 'Extract specific columns from a CSV file.', path: '/csv-column-selector', Icon: CsvColumnSelectorIcon, Page: CsvColumnSelectorPage, category: 'File Converters & Utilities', borderColor: 'border-purple-500', isPremium: true },
  { name: 'DOCX Header/Footer Extractor', description: 'Extract headers and footers from DOCX files.', path: '/docx-header-footer-extractor', Icon: DocxHeaderFooterExtractorIcon, Page: DocxHeaderFooterExtractorPage, category: 'File Converters & Utilities', borderColor: 'border-purple-500', isPremium: true },
  { name: 'File Type Checker', description: 'Check file type based on binary signature.', path: '/file-type-checker', Icon: FileTypeCheckerIcon, Page: FileTypeCheckerPage, category: 'File Converters & Utilities', borderColor: 'border-purple-500', isPremium: true },
