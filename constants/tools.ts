...
export const TOOLS: Tool[] = [
  ...
  { name: 'Business Day Calculator', description: 'Calculate business days between dates.', path: '/business-day-calculator', Icon: BusinessDayCalculatorIcon, Page: BusinessDayCalculatorPage, category: 'Calculators & Time Tools', borderColor: 'border-teal-500' },
  ...
  { name: 'Mortgage Refinance', description: 'Calculator for mortgage refinancing.', path: '/mortgage-refinance-calculator', Icon: MortgageRefinanceCalculatorIcon, Page: MortgageRefinanceCalculatorPage, category: 'Calculators & Time Tools', borderColor: 'border-teal-500' },
  { name: 'Retirement Savings', description: 'Calculator for retirement savings.', path: '/retirement-savings-calculator', Icon: RetirementSavingsCalculatorIcon, Page: RetirementSavingsCalculatorPage, category: 'Calculators & Time Tools', borderColor: 'border-teal-500' },
  { name: 'Loan Amortization', description: 'Generate a loan amortization schedule.', path: '/loan-amortization-schedule', Icon: LoanAmortizationScheduleIcon, Page: LoanAmortizationSchedulePage, category: 'Calculators & Time Tools', borderColor: 'border-teal-500' },
  ...
  { name: 'MD5 Hash Generator', description: 'Generate an MD5 hash of a string.', path: '/md5-hash-generator', Icon: Md5HashGeneratorIcon, Page: Md5HashGeneratorPage, category: 'Web & Developer Tools', borderColor: 'border-indigo-500' },
  ...
  { name: '.htaccess Auth Generator', description: 'Generate .htaccess basic authentication files.', path: '/htaccess-auth-generator', Icon: HtaccessAuthGeneratorIcon, Page: HtaccessAuthGeneratorPage, category: 'Web & Developer Tools', borderColor: 'border-indigo-500' },
  ...
  { name: 'Code Snippet Runner', description: 'Run HTML, CSS, and JS snippets in the browser.', path: '/code-snippet-runner', Icon: CodeSnippetRunnerIcon, Page: CodeSnippetRunnerPage, category: 'Web & Developer Tools', borderColor: 'border-indigo-500' },
  ...
  { name: 'JSON to SQL Insert', description: 'Convert JSON to SQL insert statements.', path: '/json-to-sql-insert', Icon: JsonToSqlInsertIcon, Page: JsonToSqlInsertPage, category: 'Web & Developer Tools', borderColor: 'border-indigo-500' },
  { name: 'JSON Array Shuffler', description: 'Randomize the order of items in a JSON array.', path: '/json-array-shuffler', Icon: JsonArrayShufflerIcon, Page: JsonArrayShufflerPage, category: 'Web & Developer Tools', borderColor: 'border-indigo-500' },
