...
const RemoveQuotesFromLinesPage: React.FC = () => {
  ...
  const handleRemove = () => {
    ...
    const unquotedLines = lines.map(line => line.replace(/^['"]|['"]$/g, ''));
  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      <div className="flex items-center gap-4 mb-8">
        <RemoveQuotesFromLinesIcon className="w-10 h-10 text-violet-400" />
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800">Remove Quotes from Lines</h1>
      </div>
      ...
      <div className="mt-6 flex flex-wrap gap-3 items-center">
        <button onClick={handleRemove} className="px-5 py-2.5 bg-violet-400 text-white font-bold rounded-lg hover:bg-violet-500 transition shadow-md">Remove Quotes</button>
...
export default RemoveQuotesFromLinesPage;
