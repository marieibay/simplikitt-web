...
const ImageNoiseGeneratorPage: React.FC = () => {
    ...
    return (
        <div className="container mx-auto p-4 md:p-8">
            <div className="flex items-center gap-4 mb-8">
                <ImageNoiseGeneratorIcon className="w-10 h-10 text-gray-400" />
                <h1 className="text-3xl md:text-4xl font-bold text-gray-800">Image Noise Generator</h1>
            </div>

            {!imageSrc ? (
                <div className="text-center p-8 border-2 border-dashed border-gray-300 rounded-lg">
                    <button onClick={() => fileInputRef.current?.click()} className="px-6 py-3 bg-gray-400 text-white font-bold rounded-lg hover:bg-gray-500 transition shadow-lg text-lg">
                        Select Image
                    </button>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <div className="p-4 bg-white rounded-lg shadow-md border space-y-4">
                            <div>
                                <label className="block font-medium">Noise Intensity: {intensity}</label>
                                <input type="range" min="0" max="100" value={intensity} onChange={(e) => setIntensity(parseInt(e.target.value))} className="w-full mt-1 accent-gray-400" />
                            </div>
...
export default ImageNoiseGeneratorPage;