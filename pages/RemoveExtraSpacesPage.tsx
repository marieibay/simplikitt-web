...
const RemoveExtraSpacesPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      <div className="flex items-center gap-4 mb-8">
        <RemoveExtraSpacesIcon className="w-10 h-10 text-stone-500" />
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800">Remove Extra Spaces</h1>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <textarea
            ...
            className="w-full h-80 p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-stone-500 focus:border-stone-500 transition"
          />
        </div>
        <div>
      ...
      <div className="mt-6 flex flex-wrap gap-3 items-center">
        <button onClick={handleRemoveSpaces} className="px-5 py-2.5 bg-stone-500 text-white font-bold rounded-lg hover:bg-stone-600 transition shadow-md">
          Remove Spaces
        </button>
