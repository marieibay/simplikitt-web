  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800">PDF Page Deleter</h1>
      </div>
      <div className="p-8 md:p-12 border-2 border-dashed border-gray-300 rounded-lg text-center bg-gray-50">
        ...
        <p className="mt-2 text-gray-600 max-w-md mx-auto">
          Removing specific pages from a PDF file is a premium feature. Please upgrade to unlock this tool.
        </p>
