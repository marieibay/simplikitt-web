...
const ImageRotatorPage: React.FC = () => {
    ...
    return (
        <div className="container mx-auto p-4 md:p-8">
            <div className="flex items-center gap-4 mb-8">
                <ImageRotatorIcon className="w-10 h-10 text-fuchsia-500" />
                <h1 className="text-3xl md:text-4xl font-bold text-gray-800">Image Rotator</h1>
            </div>

            {!imageSrc ? (
                 <div className="text-center p-8 border-2 border-dashed border-gray-300 rounded-lg">
                    <button onClick={() => fileInputRef.current?.click()} className="px-6 py-3 bg-fuchsia-500 text-white font-bold rounded-lg hover:bg-fuchsia-600 transition shadow-lg text-lg">
                        Select Image
                    </button>
                    ...
                    <div className="lg:col-span-2">
                     ...
                     <div>
                        ...
                        <div className="p-4 bg-white rounded-lg shadow-md border space-y-4">
                            ...
                            <button onClick={() => { setImageSrc(''); setAngle(0); if(fileInputRef.current) fileInputRef.current.value = ""; }} className="w-full mt-2 py-2 bg-gray-200 text-gray-800 font-semibold rounded-lg hover:bg-gray-300 transition shadow">
                                Clear Image
                            </button>
                        </div>
                    </div>
