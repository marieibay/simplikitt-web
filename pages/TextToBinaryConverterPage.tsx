...
const TextToBinaryConverterPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      <div className="flex items-center gap-4 mb-8">
        <TextToBinaryConverterIcon className="w-10 h-10 text-gray-600" />
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800">Text to Binary Converter</h1>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <textarea
            ...
            className="w-full h-80 p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-gray-600 focus:border-gray-600 transition"
          />
        </div>
        <div>
          <label htmlFor="output-text" className="block text-sm font-medium text-gray-700 mb-1">Binary Output</label>
          <textarea
            id="output-text"
            value={output}
            readOnly
      ...
      <div className="mt-6 flex flex-wrap gap-3 items-center">
        <button onClick={handleConvert} className="px-5 py-2.5 bg-gray-600 text-white font-bold rounded-lg hover:bg-gray-700 transition shadow-md">
          Convert
        </button>
...
export default TextToBinaryConverterPage;