  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      <div className="flex items-center gap-4 mb-8">
        <ScientificNotationIcon className="w-10 h-10 text-teal-500" />
      ...
      <div className="p-8 md:p-12 border-2 border-dashed border-gray-300 rounded-lg text-center bg-gray-50">
        ...
        <p className="mt-2 text-gray-600 max-w-md mx-auto">
          Converting numbers to and from scientific notation is a premium feature. Please upgrade your membership to unlock this tool.
        </p>
