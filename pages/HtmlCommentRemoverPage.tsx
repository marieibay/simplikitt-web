...
const HtmlCommentRemoverPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      <div className="flex items-center gap-4 mb-8">
        <HtmlCommentRemoverIcon className="w-10 h-10 text-orange-600" />
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800">HTML Comment Remover</h1>
      </div>
      ...
      <button onClick={removeComments} className="mt-6 px-5 py-2.5 bg-orange-600 text-white font-bold rounded-lg">Remove Comments</button>
    </div>
  );
};

export default HtmlCommentRemoverPage;
