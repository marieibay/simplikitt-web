...
const ImageOpacitySliderPage: React.FC = () => {
  return (
    <div className="container mx-auto p-4 md:p-8">
      <div className="flex items-center gap-4 mb-8">
        <ImageOpacitySliderIcon className="w-10 h-10 text-gray-400" />
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800">Image Opacity Slider</h1>
      </div>
...
export default ImageOpacitySliderPage;
