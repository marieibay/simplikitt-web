...
const ImageCropPresetPage: React.FC = () => {
  return (
    <div className="container mx-auto p-4 md:p-8">
      <div className="flex items-center gap-4 mb-8">
        <ImageCropPresetIcon className="w-10 h-10 text-rose-600" />
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800">Crop to Aspect Ratio Preset</h1>
      </div>
...
export default ImageCropPresetPage;
